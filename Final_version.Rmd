...
df = read.csv("D:/Github/Group_states/wage.csv")
walmart = read.csv("D:/Github/Group_states/walmart.csv")
target = read.csv("D:/Github/Group_states/target.csv")
geo = read.csv("D:/Github/Group_states/states.csv")
unemploy_2020 <- read_excel("D:/Github/Group_states/unemploy_2020.xlsx")
```
...
unemploy_2019 <- read_excel("D:/Github/Group_states/unemploy_2019.xlsx")
...
cces=read.csv("D:/Github/Group_states/unemployall.csv")
